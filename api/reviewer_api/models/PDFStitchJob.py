    ...
    def insert(cls, row):
        try:
            ...
            return DefaultMethodResult(
                True,
                "PDF Stitch Job recorded for ministryrequestid: {0}".format(
    ...
    def getrecordschanged(cls, requestid, category, jobid):
        try:
            query1 = (
                ...
                .join(
                    DocumentMaster,
                    DocumentMaster.ministryrequestid == PDFStitchJob.ministryrequestid,
                )
                .filter(
                    and_(
                        PDFStitchJob.ministryrequestid == requestid,
            ...
            query2 = (
                ...
                .join(
                    DocumentDeleted,
                    DocumentDeleted.ministryrequestid == PDFStitchJob.ministryrequestid,
                )
                .filter(
                    and_(
                        PDFStitchJob.ministryrequestid == requestid,
