...
class redactionservice:
    ...
    def deactivateannotation(self, annotationname, documentid, documentversion, userinfo,requestid, page, updatepageflags):
        result =  annotationservice().deactivateannotation(annotationname, documentid, documentversion, userinfo)
        if result.success == True and page is not None and updatepageflags == "true":
            documentpageflagservice().removepageflag(requestid, documentid, documentversion, page, userinfo)
        return result

    def deactivateredaction(self, annotationname, documentid, documentversion, userinfo,requestid, page, updatepageflags):
        result = annotationservice().deactivateannotation(annotationname, documentid, documentversion, userinfo)
        if result.success == True and updatepageflags == "true":
