class dedupeproducermessage(object):
    def __init__(self,s3filepath,bcgovcode,requestnumber,filename,ministryrequestid,attributes,batch,jobid,documentmasterid,trigger,createdby,outputdocumentmasterid=None,originaldocumentmasterid=None,incompatible=None) -> None:
