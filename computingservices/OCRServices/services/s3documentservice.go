...
func GetFilefroms3(message *models.OCRProducerMessage) (string, *models.S3Credentials, string, error) {
...
func generatePresignedUploadURL(endpoint, accessKey, secretKey, bucketName, fullFilePath,
	region string, expiry time.Duration) (string, error) {
	objectKey := strings.SplitN(fullFilePath, bucketName, 2)[1]
	//fmt.Println("Object Key:", objectKey)
