...
class RedlineBlobStitchMsgSchema(Schema, baseobj):
...
def get_in_divisionblobmsg(producer_json):    
    print("inside get_in_divisionblobmsg")
    #print(producer_json)
    messageobject = RedlineBlobStitchMsgSchema().load(__formatmsg(producer_json))
