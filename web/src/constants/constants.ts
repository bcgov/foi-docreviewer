...
export const HTTP_GET_TIMEOUT = window._env_?.REACT_APP_HTTP_GET_TIMEOUT ?? process.env.REACT_APP_HTTP_GET_TIMEOUT ?? 300000;
export const SOLR_HTTP_GET_TIMEOUT = window._env_?.REACT_APP_SOLR_HTTP_GET_TIMEOUT ?? process.env.REACT_APP_SOLR_HTTP_GET_TIMEOUT ?? 300000;
