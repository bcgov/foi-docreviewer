...
export const POLYGON_REDACTION_APPROX_DEPTH = window._env_?.REACT_APP_POLYGON_REDACTION_APPROX_DEPTH ?? process.env.REACT_APP_POLYGON_REDACTION_APPROX_DEPTH ?? 6
