  ...
  useEffect(() => {
    WebViewer(
      ...
      documentViewer.addEventListener('documentLoaded', () => {
        ...
        // const _annotations = annotationManager.importAnnotationCommand(_savedannotations)

        // var _savedannotations = localStorage.getItem("savedannotations")
        // const _annotations = annotationManager.importAnnotations(_savedannotations)
        ...
        fetchAnnotations(
          ...
          (data) => {
            ...
            documentViewer.displayPageLocation(1, 0, 0)
            setDocumentViewer(documentViewer)
          },
          (error) => {
            console.log('error');
