...
export const handleRedlineForSignOffClick = (setModalFor, setModalTitle, setModalMessage, setModalButtonLabel, setRedlineModalOpen) => {
...
export const handleRedlineForOipcClick = (setModalFor, setModalTitle, setModalMessage, setModalButtonLabel, setRedlineModalOpen) => {
    console.log("oipcbtn")  
    // Save to s3
...
export const handleFinalPackageClick = (setModalFor, setModalTitle, setModalMessage, setModalButtonLabel, setRedlineModalOpen) => {
